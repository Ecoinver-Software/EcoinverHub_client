  ...
  template: `
    <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      <div class="w-full max-w-none px-3 xs:px-4 sm:px-6 md:px-8 lg:px-8 xl:px-12 2xl:px-16 py-4 xs:py-6 sm:py-8 lg:py-12">
        ...
        <!-- Loading State -->
        <div *ngIf="isLoadingUser" class="flex justify-center items-center min-h-[400px]">
          <div class="animate-spin rounded-full h-12 w-12 border-b-2 border-green-500"></div>
        </div>

        <!-- Grid Principal -->
        <div *ngIf="!isLoadingUser && userProfile" class="grid grid-cols-1 lg:grid-cols-12 gap-6 xs:gap-8 sm:gap-10">
            ...
            <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl sm:rounded-2xl shadow-lg border border-gray-200/50 dark:border-gray-700/50 overflow-hidden">
              <div class="p-6 xs:p-8 text-center">
                ...
                <div class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-200 mb-6">
                  ...
                  {{ userProfile.roles || 'Usuario' }}
                </div>
                
                <!-- Estadísticas -->
                <div class="grid grid-cols-2 gap-4 pt-6 border-t border-gray-200 dark:border-gray-700">
                  <div class="text-center">
                    <div class="text-lg xs:text-xl font-semibold text-gray-900 dark:text-white">{{ getDaysActive() }}</div>
                    <div class="text-xs text-gray-500 dark:text-gray-400">Días activo</div>
                  </div>
                  <div class="text-center">
                    <div class="text-lg xs:text-xl font-semibold text-gray-900 dark:text-white">{{ getAccountAge() }}</div>
                    <div class="text-xs text-gray-500 dark:text-gray-400">Antigüedad</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl sm:rounded-2xl shadow-lg border border-gray-200/50 dark:border-gray-700/50">
              ...
              <div class="p-4 xs:p-5 sm:p-6 space-y-3">
                <button 
                  ...
                  class="w-full flex items-center p-3 hover:bg-gray-50 dark:hover:bg-gray-700/50 rounded-lg transition-all duration-200 group">
              ...
              <div class="p-6 xs:p-8">
                ...
                <div *ngIf="activeTab === 'info'">
                  <div class="mb-6">
                    ...
                    <p class="text-gray-600 dark:text-gray-400">Información general de usuario</p>
                  </div>
                  ...
                  <form [formGroup]="profileForm" (ngSubmit)="updateProfile()" class="space-y-6">
                    ...
                    <div class="mt-6 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                      <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Información de la cuenta</h4>
                      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        <div>
                          <span class="text-gray-600 dark:text-gray-400">ID de usuario:</span>
                          <span class="ml-2 font-medium text-gray-900 dark:text-white">{{ userProfile.id }}</span>
                        </div>
                        <div>
                          <span class="text-gray-600 dark:text-gray-400">Miembro desde:</span>
                          <span class="ml-2 font-medium text-gray-900 dark:text-white">{{ formatDate(userProfile.createdAt) }}</span>
                        </div>
                      </div>
                    </div>
                ...
                <div *ngIf="activeTab === 'security'">
                  ...
                  <form [formGroup]="securityForm" (ngSubmit)="updatePassword()" class="space-y-6">
                    ...
                    <div class="text-center py-8 text-gray-500">
                      ...
                      <p>Cambio de contraseña próximamente disponible</p>
                    </div>
                  </form>
                </div>
        ...
        <!-- Error State -->
        <div *ngIf="!isLoadingUser && !userProfile" class="text-center py-12">
          <svg class="w-16 h-16 mx-auto mb-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
          </svg>
          <p class="text-gray-600 dark:text-gray-400">No se pudo cargar la información del perfil</p>
          <button 
